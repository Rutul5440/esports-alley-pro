...
import { BadgeCheck, Loader2, Sparkles, Trophy, ShieldCheck, Target, Users, Landmark, Chrome, Eye, EyeOff } from "lucide-react";
          ...
          <div className="max-w-2xl py-8 sm:py-10 relative z-10">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {[
                ...
                <div key={title} className="rounded-xl border border-white/5 bg-white/[0.01] p-4 hover:border-primary/45 hover:bg-white/[0.04] transition-all duration-300 group glass-auth-item">
          ...
          <div className="w-full max-w-md space-y-6">
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <div className="relative flex py-2 items-center">
                ...
                <span className="flex-shrink mx-4 text-[9px] text-zinc-500 uppercase tracking-widest font-mono">Or Connect With</span>
                <div className="flex-grow border-t border-white/5"></div>
              </div>
...
function Field({
  ...
  type = "text",
  ...rest
}: { label: string; onChange: (v: string) => void; required?: boolean } & Omit<React.InputHTMLAttributes<HTMLInputElement>, "onChange">) {
