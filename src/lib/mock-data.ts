...
export const mockPlayers: PlayerProfile[] = [
  {
    id: "1", username: "ghostsniper", displayName: "GhostSniper",
    avatar: "https://i.pravatar.cc/200?img=12", banner: "",
    bio: "Pro BGMI sniper. 3x tournament finalist. Looking for tier-1 org.",
    location: "Mumbai, India", team: "Free Agent", rank: "Conqueror", tier: 1,
    roles: ["Sniper", "Scout"], preferredGames: ["bgmi"], badges: ["Elite", "Master"],
    skillScore: 96, profileViews: 18400, isOpenToTeam: true,
    ...
    clips: [{ id: "c1", title: "4K Clutch Erangel", url: "", thumbnail: "https://picsum.photos/seed/clip1/640/360", views: 12400, likes: 980, uploadedAt: "2025-04-10" }],
    followers: 12400, following: 180, verified: true,
  },
  {
    id: "2", username: "iglraven", displayName: "IGL Raven",
    avatar: "https://i.pravatar.cc/200?img=33", banner: "",
    bio: "In-game leader. Calm calls under pressure.",
    location: "Delhi, India", team: "Team Phoenix", rank: "Ace", tier: 2,
    roles: ["IGL", "Support"], preferredGames: ["bgmi", "valorant"], badges: ["Contender", "Elite"],
    skillScore: 88, profileViews: 9300, isOpenToTeam: false,
    ...
    clips: [], followers: 6200, following: 240,
  },
  {
    id: "3", username: "flickking", displayName: "FlickKing",
    avatar: "https://i.pravatar.cc/200?img=15", banner: "",
    bio: "Assaulter. TDM rated. Open to scrims and academy tryouts.",
    location: "Bangalore, India", team: "Free Agent", rank: "Crown", tier: 1,
    roles: ["Assaulter"], preferredGames: ["bgmi", "cs2"], badges: ["Rookie", "Contender"],
    skillScore: 91, profileViews: 14800, isOpenToTeam: true,
    ...
    clips: [], followers: 9800, following: 90, verified: true,
  },
];

export const mockOrganizations: OrganizationProfile[] = [
  {
    id: "o1", username: "apexlegion", name: "Apex Legion",
    ...
    location: "India", verified: true, followers: 42800,
    activeGames: ["bgmi", "valorant"], openRoles: ["Assaulter", "Support"],
  },
];
