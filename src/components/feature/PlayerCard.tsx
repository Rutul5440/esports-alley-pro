    ...
    <article className="rounded-lg border border-border bg-card p-4">
      ...
      <div className="mt-4 grid grid-cols-3 gap-2">
        <button
          type="button"
          onClick={onSave}
          className="inline-flex items-center justify-center gap-1.5 rounded-md border border-border px-2 py-2 text-xs hover:border-primary/50"
        >
        ...
        <button
          type="button"
          onClick={onInvite}
          className="inline-flex items-center justify-center gap-1.5 rounded-md bg-primary/10 px-2 py-2 text-xs font-semibold text-primary"
        >
          <Mail size={14} /> Invite
        </button>
      </div>
