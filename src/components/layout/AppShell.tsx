            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
              <div className="space-y-4">
                ...
                <p className="text-sm leading-relaxed text-muted-foreground/80">
                  The professional career hub and scouting matrix for esports players. Build your
                  digital card, showcase elite verified stats, and get signed by leading
                  organizations.
                </p>
              </div>
              <div>
                <h3 className="text-xs font-semibold uppercase tracking-wider text-gold font-display">
                  Platform Matrix
                </h3>
                <div className="mt-4 grid gap-2.5 text-sm">
                  <Link
                    to="/explore"
                    className="text-muted-foreground hover:text-gold transition-colors inline-flex items-center"
                  >
                    Explore Players
                  </Link>
                  <Link
